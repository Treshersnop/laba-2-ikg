...
void Pipeline::InitPerspectiveProj(Matrix4f& m) const//параметры для проецирования перспективы
{
...
const Matrix4f* Pipeline::GetTrans()
{
    ...
    /*инициализирует три отдельные матрицы для преобразования с текущими параметрами
    Оно умножает их одну за другой и выводит итоговый результат*/
    ...
    //генерирование итогового преобразования
